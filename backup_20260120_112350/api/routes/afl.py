...
async def generate_afl(
    ...
    """Generate AFL code from natural language description."""
...
# api/routes/afl.py - IMPROVED VERSION
...
async def generate_afl(
    ...
    """Generate AFL code with mandatory question flow."""
...
Please ask these questions clearly and wait for the user's response. Do NOT generate any code yet."""
        ...
        # PHASE 2: Generate code with answers
            ...
            settings = BacktestSettings(trade_delays=trade_delays) if request.settings else None
